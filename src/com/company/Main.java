    ...
    public static void main(String args[])
    {
        ...
        do {
            ...
            try {
                ...
                System.out.print("Kapasitas maksimum truk : 12");
                int capacity = 12;
                repeatFlag = false;
                ...
                System.out.println("----------------------------------------------------------------------------------------------");
                System.out.println("Nama Barang\t\t\t\tBerat\t\tProfit\t\tProfit/Berat\tQuantity");
                ...
                System.out.println("----------------------------------------------------------------------------------------------");
                System.out.print("Barang yang terpilih: | ");
                int totalWeight = 0;
                for (int i = 0; i < item.length; i++) {
                ...
                System.out.println("Profit maksimal: " + upper);
            }
